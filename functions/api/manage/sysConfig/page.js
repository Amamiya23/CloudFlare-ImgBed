...
export async function getPageConfig(db, env) {
    ...
    config.push(
        ...
        },
        {
            ...
            tooltip: '直接粘贴图片链接即可，多个链接换行输入将自动轮播；也可填写 bing 使用必应壁纸',
            tooltip_en: 'Paste image links directly, one per line for rotation. Enter bing for Bing wallpapers',
            category: '客户端设置',
            category_en: 'Client Settings',
        },
        {
